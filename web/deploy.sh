...
cat app.css login.css css/ElementList.css css/EditEntryForm.css css/NewEntryForm.css css/Navbar.css css/EntryMenu.css css/CommentList.css > $TARGETFOLDER/$WEBFOLDERNAME/app.css
...
node_modules/handlebars/bin/handlebars hb/Navbar.hb hb/EntryMenu.hb hb/CommentList.hb >> $TARGETFOLDER/$WEBFOLDERNAME/templates.js
